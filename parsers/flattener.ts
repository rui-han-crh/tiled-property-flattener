import type { TiledGameObjectProperties } from '../data/tiled_class_behaviours/tiled_properties_interface';
...
export class Flattener {
    private readonly memoiser = new Map<string, TiledGameObjectProperties>();
    ...
    */
    ...
    public get memoisedFlattenedProperties (): ReadonlyMap<string, TiledGameObjectProperties> {
